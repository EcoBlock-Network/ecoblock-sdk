                ...
                children: [
                  ...
                  lootAsync.when(
                    data: (loot) => loot.isNotEmpty
                        ...
                        : Center(child: Text(tr(context, 'no_loot'), style: const TextStyle(color: Colors.grey))),
                    loading: () => const Center(child: CircularProgressIndicator()),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(tr(context, 'profile.block_history_title'), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                                    Text(tr(context, 'profile.block_history_sub'), style: const TextStyle(color: Colors.grey)),
                                  ],
                                ),
                              ),
